...
if(isset($_SESSION['staff']) && $_SESSION['staff'] == 'true'){
	#If the user is staff, redirect them
	header ("Location: users_area_staff.php");
} else if(isset($_SESSION['staff']) && $_SESSION['staff'] == 'false') {
	#If the user isn't staff do nothing
...
<html>
	<head>
		<title>Aston Animal Sanctuary - User area</title>
	...
	<body>
		<div class="container" id="page">
				...
				<ul class="nav navbar-nav">
				  ...
				  <?php
					...
					if(isset($_SESSION['username']) && $_SESSION['staff'] == 'true'){
						...
						echo '<li><a id="active" href="user_area_normal.php">User area</a></li>';
						echo '<li><a href="animals.php">Animals</a></li>';
					}
				  ?>
				</ul>
			...
			<?php
				$sql = "SELECT * FROM cs2410.adoptionrequest WHERE userID = '$username' ";
				$result = $db->query($sql);
				...
				foreach($result as $row){
					...
					foreach($result_a as $row_a){
						echo "<div class='row'>
							 <div class='col-md-2'>" . "<img src=".$row_a['photo']." alt='Photo' height='50' width='50'>" . "</div>
							 <div class='col-md-2'>" . $row_a['name'] . "</div>
